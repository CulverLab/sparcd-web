...
export default function UserMessages({onAdd, onDelete, onRefresh, onRead, onClose}) {
    ...
    return (
        ...
        { curMessages && curMessages.length > 0 &&
          curMessages.map((item, idx) =>
            <Grid id={'message-line-'+idx} key={'message-line-'+idx} wrap="nowrap" container direction="row" alignItems="center" justifyContent="start"
  ...
  function generateMessages() {
    return (
      <Grid id='messages-details-wrapper' container direction="column" justifyContent="start" alignItems="start"
        ...
        <MessagesToolbar haveSelectedMessages={selectedMessages.length !== 0} 
  ...
  <React.Fragment>
    ...
    { (readMessage !== null || newMessage) && 
        <ViewMessage curMessage={newMessage ? null : readMessage} messageType={messageType}
